		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					...
					You can be confident when you're shopping online withAna Online Store. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
...
<!-- Begin Sidebar -->
		...
		<!-- End Main -->
					...
					</div>	<p align="center">&copy;Ana Online Store.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong>Ana Online Store</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
